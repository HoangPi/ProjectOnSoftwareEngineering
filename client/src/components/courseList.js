                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <a href="#"><img src={props.thumbnail} width='80px' height='60px' alt="course" class="rounded img-4by3-lg" /></a>
                                            </div>
                                            <div class="ms-3">
                                                <h4 class="mb-1 h5">
                                                    <a href="#" class="text-inherit">{props.coursename}</a>
                                                </h4>
